provider "aws" {
  region  = "us-east-2"
  access_key = "AKIAXXXXXXXXXXX" #REPLACE IT WITH YOURS, HOWEVER IT IS NOT RECOMMENDED TO HAVE THE KEY HERE. YOU HAVE BEEN WARNED!!!!
  secret_key = "1XXXXXXXXXXXXXXXXXXXXX" #REPLACE IT WITH YOURS, HOWEVER IT IS NOT RECOMMENDED TO HAVE THE KEY HERE.YOU HAVE BEEN WARNED!!!!
}
