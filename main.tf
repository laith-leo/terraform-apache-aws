provider "aws" {
  region  = "us-east-2"
  access_key = "AKIAXXXXXXXXXXX" #REPLACED WITH YOURS, HOWEVER IT IS NOT RECOMMENDED TO HAVE THE KEY HERE. YOU HAVE BEEN WARNNED!!!!
  secret_key = "1XXXXXXXXXXXXXXXXXXXXX" #REPLACED WITH YOURS, HOWEVER IT IS NOT RECOMMENDED TO HAVE THE KEY HERE.YOU HAVE BEEN WARNNED!!!!
}
